...
class _AddRecordDialogState extends State<AddRecordDialog> {
  ...
  void initState() {
    ...
    _durationMinutes = r?.duration.inMinutes ?? 15;
    ...
    if (widget.prefillDuration != null && r == null) {
      _durationMinutes = widget.prefillDuration!.inMinutes.clamp(1, 180);
    }
    ...
    return Dialog(
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Text(_isEditing ? l10n.intimacyEditRecord : l10n.intimacyNewRecord,
            ...
            Row(
              children: [
                Text('${l10n.intimacyPleasure}:', style: theme.textTheme.bodyMedium),
            ...
            Row(
              children: [
                Text('${l10n.intimacyDuration}:', style: theme.textTheme.bodyMedium),
                const SizedBox(width: 8),
            ...
            TextField(
              ...
              decoration: InputDecoration(
                labelText: l10n.intimacyLocation,
              ),
            ),
            const SizedBox(height: 12),
