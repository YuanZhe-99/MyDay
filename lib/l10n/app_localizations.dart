...
abstract class AppLocalizations {
  ...
  String get financeAccountPickerSettings;

  /// No description provided for @financeAccountPickerGroupByType.
  ///
  /// In en, this message translates to:
  /// **'Group by account type'**
  String get financeAccountPickerGroupByType;

  /// No description provided for @financeAccountPickerCustomOrder.
  ///
  /// In en, this message translates to:
  /// **'Custom account order'**
  String get financeAccountPickerCustomOrder;

  /// No description provided for @financeAccountPickerMoreAccounts.
  ///
  /// In en, this message translates to:
  /// **'Accounts in More'**
  String get financeAccountPickerMoreAccounts;

  /// No description provided for @financeAccountPickerMoreDescription.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @financeAccountPickerMore.
  ///
  /// In en, this message translates to:
  /// **'More'**
  String get financeAccountPickerMore;

  /// No description provided for @financeAccountPickerShowMore.
  ///
  /// In en, this message translates to:
  /// **'More ({count})'**
