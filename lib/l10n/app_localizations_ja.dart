...
class AppLocalizationsJa extends AppLocalizations {
  ...
  @override
  String get financeAccountPickerGroupByType => '口座タイプでグループ化';

  @override
  String get financeAccountPickerCustomOrder => 'カスタム口座順';

  @override
  String get financeAccountPickerMoreAccounts => 'さらに表示に入れる口座';

  @override
  String get financeAccountPickerMoreDescription =>
      'チェックした口座は取引の口座選択で非表示になり、さらに表示をタップすると表示されます。';

  @override
  String get financeAccountPickerMore => 'さらに表示';
  ...
  @override
  String get intimacyBody => 'ボディ';

  @override
  String get intimacyTabRecords => '記録';
  ...
  String get intimacyBodyWeightSyncWarning =>
      'ここでの変更は体重モジュールと同期され、新しい体重記録が作成されます。';

  @override
  String get intimacyBodyDontRemindAgain => '今後表示しない';

  @override
  String get intimacyBodyDontRemindAgainDesc => 'サイズ変更で新しい体重記録を作成する際の警告を表示しません';

  @override
  String get intimacyBodyUnderbust => 'アンダーバスト';

  @override
  String get intimacyBraSize => 'ブラサイズ';

  @override
  String get intimacyBraStandard => 'サイズ規格';

  @override
  String get intimacyBraStandardEu => 'EU / EN 13402';

  @override
  String get intimacyBraStandardFrEs => 'フランス / スペイン';

  @override
  String get intimacyBraStandardJp => '日本 / JIS';

  @override
  String get intimacyBraStandardUk => 'イギリス';

  @override
  String get intimacyBraStandardUs => 'アメリカ';

  @override
  String get intimacyBraStandardAuNz => 'オーストラリア / ニュージーランド';

  @override
  String get intimacyBraEstimatedSize => '推定サイズ';

  @override
  String get intimacyBraOutOfRange => '対応サイズ範囲外です';

  @override
  String get intimacyBraEstimateDisclaimer =>
      '計算結果はあくまで推定サイズです。実際のフィット感はブランド、デザイン、測定方法によって異なる場合があります。';

  @override
  String get intimacyBraUsVariance =>
      'アメリカのカップ表記はブランドによって大きく異なるため、結果は目安としてください。';

  @override
  String get intimacyBraHelpTitle => 'ブラサイズの計算方法';

  @override
  String get intimacyBraHelpEu =>
      'EN 13402 ではアンダーバストを最も近い5cm刻みのバンド（58–62 → 60、63–67 → 65 など）に丸めます。カップはトップバストとアンダーバストの差で決まり、10–12cm → AA、以降2cmごとに1カップ上がり、26–28cm → H です。';

  @override
  String get intimacyBraHelpFrEs =>
      'フランス / スペインは EU のカップを使い、バンド番号は EU に15を加えた値です（EU 70 → 85、EU 75 → 90、EU 80 → 95）。';

  @override
  String get intimacyBraHelpJp =>
      '日本 / JIS はアンダーバストを最も近い5cm刻みに丸め、カップは約2.5cmごとに1段階上がります（10.0cm → A、12.5cm → B、15.0cm → C など、各段階は約±1.25cm）。サイズは C75 のようにカップを先に表記します。';

  @override
  String get intimacyBraHelpUk =>
      'イギリスのバンドは EU バンドから換算します（EU 60 → 28、65 → 30、70 → 32、75 → 34、80 → 36）。カップは差が約1インチ増えるごとに1段階上がります：1インチ → A、2 → B、3 → C、4 → D、5 → DD、6 → E、7 → F、8 → FF、9 → G、10 → GG、11 → H。';

  @override
  String get intimacyBraHelpUs =>
      'アメリカはイギリスと同じバンド番号を使い、カップは A、B、C、D、DD/E、DDD/F、G、H、I、J、K の順で、差が約1インチ増えるごとに1段階上がります。表記はブランドによって大きく異なります。';

  @override
  String get intimacyBraHelpAuNz =>
      'オーストラリア / ニュージーランドはイギリスのカップを使い、バンドはドレスサイズ表記です（UK 30 → 8、32 → 10、34 → 12、36 → 14）。';

  @override
  String get intimacyCycleTitle => '生理周期';

  @override
  String get intimacyCycleEnable => '生理周期の記録を有効にする';

  @override
  String get intimacyCycleAddStart => '生理開始日を追加';

  @override
  String get intimacyCycleStartHint =>
      '生理開始日は持続的な出血が始まった最初の日です。単発の少量出血は開始日として記録しないでください。';

  @override
  String get intimacyCycleStartDates => '生理開始日';

  @override
  String get intimacyCycleActualStart => '実際の開始日';

  @override
  String get intimacyCyclePredictedStart => '予測開始日';

  @override
  String get intimacyCyclePhaseMenstrual => '月経期';

  @override
  String get intimacyCyclePhaseFollicular => '卵胞期';

  @override
  String get intimacyCyclePhaseLuteal => '黄体期';

  @override
  String get intimacyCycleFertileWindow => '妊娠しやすい期間';

  @override
  String get intimacyCycleOvulation => '排卵日';

  @override
  String get intimacyCycleEstimatedSuffix => '（推定）';
  ...
  String get intimacyCycleDisclaimer =>
      '周期と排卵日は記録データから生成された推定値です。避妊方法や医学的助言として使用しないでください。';

  @override
  String get intimacyCycleShowOnCalendarUser => 'ホームのカレンダーに自分の周期を表示';

  @override
  String get intimacyCycleShowOnCalendarPartner => 'ホームのカレンダーにこのパートナーの周期を表示';

  @override
  String get intimacyCycleMe => '自分';

  @override
  String get intimacyPsiSection => 'ペニス測定値';

  @override
  String get intimacyPsiErectLength => '勃起時の長さ';

  @override
  String get intimacyPsiBaseCircumference => '根元の周囲長';

  @override
  String get intimacyPsiFrontCircumference => '先端側の周囲長';
  ...
  String get intimacyPsiExplanation =>
      'PSI は形状を円錐台として近似して計算するサイズ参考指数です。個人的な記録と比較のためのものであり、健康、機能、魅力、性的能力を表すものではありません。';

  @override
  String get intimacyPsiReference =>
      '成人ペニスの長さ・周囲長の統計参考文献：王存同ほか「中国と諸外国における成人陰茎の長さと周囲長の系統的分析と比較研究」中国性科学、2020年、第29巻第9号、143–148頁。PSI の計算式自体はこの文献に由来するものではありません。';
